...
public class StructuredFullMessage {
	...
	public void setEmotion_text_human_confidence(double emotion_text_human_confidence) {
	...
	public void setEmotion_media_human_confidence(List<Double> emotion_media_human_confidence) {
	...
	public String toString() {
		return "SQLmessage [num_id=" + num_id + ", MongoId=" + MongoId + ", raw_id_str=" + raw_id_str + ", creat_at="
				+ sdf.format(creat_at) + ", timestamp_ms=" + timestamp_ms + ", text=" + text + ", media_type="
				+ media_type + ", media_urls=" + media_urls + ", placeType=" + placeType + ", placeName=" + placeName
				+ ", placeFullName=" + placeFullName + ", placeBoundingType=" + placeBoundingType
				+ ", placeCoordinates=" + placeCoordinates + ", country=" + country + ", province=" + province
				+ ", city=" + city + ", geo_type=" + geo_type + ", geo_coordinates=" + geo_coordinates + ", hashtags="
				+ hashtags + ", replay_to=" + replay_to + ", lang=" + lang + ", emotion_text_human="
				+ emotion_text_human + ", emotion_text_human_times=" + emotion_text_human_times
				+ ", emotion_text_human_confidence=" + emotion_text_human_confidence + ", emotion_media_human="
				+ emotion_media_human + ", emotion_media_human_times=" + emotion_media_human_times
				+ ", emotion_media_human_confidence=" + emotion_media_human_confidence + ", emotion_text_machine="
				+ emotion_text_machine + ", emotion_media_machine=" + emotion_media_machine + ", messageFrom="
				+ messageFrom + "]";
	}
