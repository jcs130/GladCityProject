	...
	<div class="container">
		<div class="row wrapper">
			...
			| <a href="?lang=es_ES"><spring:message
					code="label.form.loginSpanish"></spring:message></a>| <a
				href="?lang=zh"><spring:message code="label.form.loginChinese"></spring:message></a>
			<br> <br>
			<form name='f' action="j_spring_security_check" method='POST'
				onsubmit="return validate();">

				<label class="col-sm-4"><spring:message
						code="label.form.loginEmail"></spring:message></label> <span
					class="col-sm-8"><input class="form-control" type='text'
					name='j_username' value=''></span> <br> <br> <label
					class="col-sm-4"><spring:message
						code="label.form.loginPass"></spring:message></label> <span
					class="col-sm-8"><input class="form-control" type='password'
					name='j_password' /></span> <br> <br> <input
			...
			<a class="btn btn-default" href="<c:url value="registration.html" />"><spring:message
					code="label.form.loginSignUp"></spring:message></a> <br> <br>
