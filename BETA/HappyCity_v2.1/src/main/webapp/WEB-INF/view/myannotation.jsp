	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					My Annotation <small>View all your annotation history here.</small>
				</h1>
			</section>
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">My Annotation History</h3>
							</div>
							<!-- /.box-header -->
										...
										<table id="example1"
											...
											<thead>
												<tr>
													...
													<th>Date</th>
													<th>Text</th>
													<th>Emotion of Text</th>
													<th>Medias</th>
													<th>Emotions of Medias</th>
												</tr>
											</thead>
