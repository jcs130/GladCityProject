			...
			<form action="/" method="POST" enctype="utf8">
				<div class="form-group row">
					<label class="col-sm-3"><spring:message
						...
						name="firstName" value="" required /></span> <span id="firstNameError"
				...
				<div class="form-group row">
					<label class="col-sm-3"><spring:message
						...
						class="col-sm-5"><input class="form-control"
						name="lastName" value="" required /></span> <span id="lastNameError"
						class="alert alert-danger col-sm-4" style="display: none"></span>
				...
				<div class="form-group row">
					<label class="col-sm-3"><spring:message
						...
						type="email" class="form-control" name="email" value="" required /></span>
				...
				<div class="form-group row">
					<label class="col-sm-3"><spring:message
							code="label.user.password"></spring:message></label> <span
						class="col-sm-5"><input id="password" class="form-control"
						name="password" value="" type="password" required /></span> <span
				...
				<div class="form-group row">
					<label class="col-sm-3"><spring:message
						...
						class="col-sm-5"><input id="matchPassword"
						class="form-control" name="matchingPassword" value=""
						type="password" required /></span> <span id="globalError"
						class="alert alert-danger col-sm-4" style="display: none"></span>
				</div>
				<br>
