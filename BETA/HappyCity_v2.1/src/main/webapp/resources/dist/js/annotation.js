	...
	var msg_id;
	//the local counter showing total number of annotated messages during the current annotation
	var counter;

	//function to get total number of annotations for [Recently Annotated Messages] box
	...
	//function to get recent annotations records for [Recently Annotated Messages] box
	...
	$(function() {
		...
		//reload the page when annotation modal is closed (to update [Recently Annotated Messages] box)
		$("#btn-closemaodal").click(function() {
			location.reload();
		});
		//clear html elements and counter when annotation modal is closed successfully
