...
public class DaoSetting {
	...
	private ArrayList<LocArea> dbAreas = new ArrayList<LocArea>();

	public ArrayList<LocArea> getDbAreas() {
		return dbAreas;
	}
	...
	public void init() {
		if (dbAreas.size() == 0) {
			...
			LocArea dbArea4 = new LocArea(50.064191736659104, 52.03125, 0,
					149.0625, "twets4");
			LocArea dbArea5 = new LocArea(0, 85.078125, -47.279229002570816,
					180, "twets5");
